...
namespace gcode {
    ...
    class G1Sequence_M5M15: public ICommand
    {
        
    public:
        
        G1Sequence_M5M15( const std::vector<Vec3_F> & positions_, const std::vector<Vec3_B> & enabledComponents_ )
    ...
    public:
        ...
        virtual std::string getSource()
        {
            if( positions.size() > 0 && enabledComponents.size() > 0 )
            {
                ...
                stream << StringUtils::lSpaceStr( "M15", GCODE_SPACES );
